...
using Android.Media;
using Android.Views;
using Imparta.Xamarin.Forms.VideoPlayer;
using Imparta.Xamarin.Forms.VideoPlayer.Android.Constants;
using Imparta.Xamarin.Forms.VideoPlayer.Android.Renderers;
using Imparta.Xamarin.Forms.VideoPlayer.Android.SourceHandlers;
using Imparta.Xamarin.Forms.VideoPlayer.Constants;
using Imparta.Xamarin.Forms.VideoPlayer.Diagnostics;
using Imparta.Xamarin.Forms.VideoPlayer.Events;
using Imparta.Xamarin.Forms.VideoPlayer.Interfaces;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Math = System.Math;
using Timer = System.Timers.Timer;
using VideoView = Imparta.Xamarin.Forms.VideoPlayer.Android.Widget.VideoView;
...
namespace Imparta.Xamarin.Forms.VideoPlayer.Android.Renderers
{
    /// <summary>
