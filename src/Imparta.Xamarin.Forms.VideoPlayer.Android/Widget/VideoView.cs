...
using Imparta.Xamarin.Forms.VideoPlayer.ExtensionMethods;
using Timer = System.Timers.Timer;
using Uri = Android.Net.Uri;

namespace Imparta.Xamarin.Forms.VideoPlayer.Android.Widget
{
    /// <summary>
    /// Displays a video file.
    /// </summary>
    [Register("Imparta.Xamarin.Forms.VideoPlayer.Android.Widget.VideoView")]
