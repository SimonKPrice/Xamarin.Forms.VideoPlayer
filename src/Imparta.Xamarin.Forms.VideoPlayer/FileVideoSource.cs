...
namespace Imparta.Xamarin.Forms.VideoPlayer
{
    /// <summary>
    /// An <see cref="T:Imparta.Xamarin.Forms.VideoPlayer.VideoSource"/> that reads a video from a file.
    /// </summary>
    [TypeConverter(typeof(FileVideoSourceConverter))]
    public class FileVideoSource : VideoSource
    {
        /// <summary>
        /// Backing store for the <see cref="P:Imparta.Xamarin.Forms.VideoPlayer.FileVideoSource.File"/> property.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the file from which this <see cref="T:Imparta.Xamarin.Forms.VideoPlayer.FileVideoSource"/> will load a video.
        /// </summary>
        public string File
        {
