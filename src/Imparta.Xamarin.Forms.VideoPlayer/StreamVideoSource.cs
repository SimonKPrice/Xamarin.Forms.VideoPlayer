...
{
    /// <summary>
    /// <see cref="T:Imparta.Xamarin.Forms.VideoPlayer.VideoSource"/> that loads a video from a <see cref="T:System.IO.Stream"/>.
    /// </summary>
    public sealed class StreamVideoSource : VideoSource
    {
        ...
        /// <summary>
        /// Backing store for the <see cref="P:Imparta.Xamarin.Forms.VideoPlayer.StreamVideoSource.Stream"/> property.
        /// </summary>
