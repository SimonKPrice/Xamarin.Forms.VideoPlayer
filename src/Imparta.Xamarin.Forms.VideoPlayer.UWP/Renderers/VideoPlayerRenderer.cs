...
using Imparta.Xamarin.Forms.VideoPlayer.UWP.Renderers;
using Imparta.Xamarin.Forms.VideoPlayer.UWP.SourceHandlers;
using Xamarin.Forms;
using Xamarin.Forms.Platform.UWP;

[assembly: ExportRenderer(typeof(VideoPlayer), typeof(VideoPlayerRenderer))]

namespace Imparta.Xamarin.Forms.VideoPlayer.UWP.Renderers
{
    /// <summary>
