...
using Imparta.Xamarin.Forms.VideoPlayer.iOS.Renderers;
using Imparta.Xamarin.Forms.VideoPlayer.iOS.SourceHandlers;
...
namespace Imparta.Xamarin.Forms.VideoPlayer.iOS.Renderers
{
        /// <summary>
